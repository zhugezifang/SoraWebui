    ...
    <>
      ...
      <main className="w-[95%] md:w-[65%] lg:w-[55%] 2xl:w-[45%] mx-auto h-full my-8">
        <div className="p-6 prose mx-auto">
          ...
          <h4 className={"font-bold"}>{privacyPolicyLanguageText.h4_1}</h4>
          <p>{privacyPolicyLanguageText.h4_1_pa}</p>
          <p>{privacyPolicyLanguageText.h4_1_pb}</p>
          <h4 className={"font-bold"}>{privacyPolicyLanguageText.h4_2}</h4>
          <p>{privacyPolicyLanguageText.h4_2_p}</p>
          <h4 className={"font-bold"}>{privacyPolicyLanguageText.h4_3}</h4>
          <p>{privacyPolicyLanguageText.h4_3_p}</p>
          <h4 className={"font-bold"}>{privacyPolicyLanguageText.h4_4}</h4>
          <p>{privacyPolicyLanguageText.h4_4_p}</p>
          <h4 className={"font-bold"}>{privacyPolicyLanguageText.h4_5}</h4>
